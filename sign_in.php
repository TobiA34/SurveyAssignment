	...
	if ($errors == "")
		{
			...
			if ($result->num_rows > 0) {
				...
				if($user['user_type'] == 'admin') {
					$message = "Hi, " . $_SESSION['username'] . " my user type is  " . $user['user_type'] . ", you have successfully logged in, please <a href='admin.php'>click here</a><br>";
				}
				else{
					$message = "Hi, " . $_SESSION['username'] . " my user type is  " . $user['user_type'] . ", you have successfully logged in, please <a href='account.php'>click here</a><br>";
				}
				echo <<<_END
				<!DOCTYPE html>
					<html lang="en">
...
<img id="website-logo" src="Images/lion.png">
<div id="sign-in-form">
<div class="border">
<form action="sign_in.php" method="post">
	Please enter your username and password:<br>
	<br>
	Username: <br> <input type="text" class="textfield" name="username" maxlength="16" value="$username" required> $username_val
	<br>
	<br>
	Password: <br>
	<input type="password" id="password" class="textfield" name="password" maxlength="16" value="$password" required> $password_val <br>
